...
void TIMER0_init(void)
{
		...
		RESET_BIT(TCCR0,1);
		RESET_BIT(TCCR0,2);
	#elif T0Prescaler == CLK
		SET_BIT(TCCR0,0);
		RESET_BIT(TCCR0,1);
		RESET_BIT(TCCR0,2);
	#elif T0Prescaler == CLK8
		RESET_BIT(TCCR0,0);
		SET_BIT(TCCR0,1);
		RESET_BIT(TCCR0,2);
	#elif T0Prescaler == CLK64
		SET_BIT(TCCR0,0);
		SET_BIT(TCCR0,1);
		RESET_BIT(TCCR0,2);
	#elif T0Prescaler == CLK256
	    RESET_BIT(TCCR0,0);
		RESET_BIT(TCCR0,1);
		SET_BIT(TCCR0,2);
	#elif T0Prescaler == CLK1024
	    SET_BIT(TCCR0,0);
		RESET_BIT(TCCR0,1);
		SET_BIT(TCCR0,2);
	#elif T0Prescaler == EXTCLKF
	    RESET_BIT(TCCR0,0);
		SET_BIT(TCCR0,1);
		SET_BIT(TCCR0,2);
	#elif T0Prescaler == EXTCLKR
	    SET_BIT(TCCR0,0);
		SET_BIT(TCCR0,1);
		SET_BIT(TCCR0,2);
	#endif
